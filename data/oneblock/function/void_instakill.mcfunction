...
execute unless entity @e[type=minecraft:zombie, limit=1, nbt={equipment:{mainhand:{id:"minecraft:iron_shovel",count:1}}}] unless entity @e[type=zombie_villager, limit=1, nbt={equipment:{mainhand:{id:"minecraft:iron_shovel",count:1}}}] if score #daytime daytime matches 0..11999 run time add 12500
